        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_penjualan">ID Transaksi Barang Keluar</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input value="<?= set_value('tanggal_keluar', date('Y-m-d')); ?>" name="tanggal_keluar" id="tanggal_keluar" type="date" class="form-control date" placeholder="Tanggal Masuk...">
