...
$sql2=mysqli_query($conn,"SELECT * FROM barang"); // memanggil data produk
...
while($c=mysqli_fetch_array($sql2)){
    ...
    id_barang='$c[id_barang]' GROUP BY YEAR(tanggal_keluar),MONTH(tgl_trans)"); // memanggil jumlah data penjualan berdasarkan bulan dan tahun
...
// echo "<br>";
?>
<h2> BARANG <?php echo $c['id_barang'] ?></h2>
