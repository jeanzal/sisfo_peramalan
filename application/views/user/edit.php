            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'admin2' ? 'checked' : ''; ?> <?= set_radio('role', 'admin2'); ?> value="admin2" type="radio" id="admin2" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="admin2">Admin2</label>
                        </div>
